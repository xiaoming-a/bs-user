        ...
        <ul>
          ...
          <li>
            ...
            <div class="f-inp">
              ...
              <input type="text" id="name" placeholder="请输入姓名" v-model.trim="model.name">
            </div>
          </li>
          ...
          <li>
            ...
            <div class="f-inp">
              <span class="iconfont icon-lunkuohua2_yonghu"></span>
              <input type="text" id="username" placeholder="请输入学号/手机号" v-model.trim="model.account">
            </div>
          </li>
          ...
          <li>
            <button class="f-btn" type="submit">注册</button>
          </li>
        </ul>
      </form>

      <!--   注册链接   -->
      <div class="zhuce" @click="$router.push('/login')">有账号么?去登录吧</div>
      <div class="tit">温馨提示：注册完成以后请完善个人资料</div>
    </div>
  </div>
</template>
